...
##################################################################################################################
# Page title
st.title("WhatsApp Group: \"Chaddi Buddies\"")

st.markdown("""
The Hyderabad Czns was created by <a href="https://wa.me/919885078965" style="color:steelblue" target="_blank">**Battu**</a> on 28-Nov-2013 around 9 PM IST.
...
st.markdown("<i>Date and time are in IST<br>Data extracted on 2023-Jun-22</i>", unsafe_allow_html=True)
